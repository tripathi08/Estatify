    ...
    <main className='p-3 max-w-4xl mx-auto'>
      ...
      <form className='flex flex-col sm:flex-row gap-10'>
        ...
        <div className='flex gap-4'>
          ...
          <button disabled={uploading} type='button' onClick={handleImageSubmit}  className='p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-60'>
        ...
        <button className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-80 disabled:opacity-60'>
        Create Listing
        </button>
        </div>
        </form>
